...
//HOMEPAGE SORT
const sortTrending = function(allProducts) {
    return allProducts.sort((a, b) => { return b.score - a.score }).slice(0, 3);
};
...
//***** PUBLIC ******//
export { getProducts, displayProducts, productsClient, sortTrending, displayTotal, mobileFilter }; 
